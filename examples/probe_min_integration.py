...
Dean, 2026-09-15: "the initial value put in the int time is not connected to the
actual Avantes spectrometer. My version at PLU can go to much smaller int times than
the one at UW."

He is right, and it matters more than a bad default: `lin_start_ms` is 0.022 and
`lin_stop_ms` is 0.15, while docs/metrohm-rig-status.md records the UW ULS2048L as
